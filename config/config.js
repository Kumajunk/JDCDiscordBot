...
export const config = {
    ...
    MCID_FILE: path.join(processCwd, "data", "mcid.json"),
    ...
    ADMIN_NOTIFY_CHANNEL_ID: process.env.ADMIN_NOTIFY_CHANNEL_ID,
    AUTO_CLEAR_EXCLUDE_USER_IDS: process.env.AUTO_CLEAR_EXCLUDE_USER_IDS || "",
    AUTO_CLEAR_KEEP_USER_IDS: process.env.AUTO_CLEAR_KEEP_USER_IDS || ""
};
